...
class LocationsApi
{
     ...
     * Get Locations
     *
     * @param  \Swagger\Client\Model\GetLocationsRequest $body body (required)
     ...
     */
    public function getLocations($body, $instance_id, $connection_id, $test_mode = 'false')
    {
        list($response) = $this->getLocationsWithHttpInfo($body, $instance_id, $connection_id, $test_mode);
        return $response;
    }
     ...
     * Get Locations
     *
     * @param  \Swagger\Client\Model\GetLocationsRequest $body (required)
     ...
     */
    public function getLocationsWithHttpInfo($body, $instance_id, $connection_id, $test_mode = 'false')
    {
        $returnType = '\Swagger\Client\Model\GetLocationsResponse';
        $request = $this->getLocationsRequest($body, $instance_id, $connection_id, $test_mode);
     ...
     */
    public function getLocationsAsync($body, $instance_id, $connection_id, $test_mode = 'false')
    {
        return $this->getLocationsAsyncWithHttpInfo($body, $instance_id, $connection_id, $test_mode)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLocationsAsyncWithHttpInfo($body, $instance_id, $connection_id, $test_mode = 'false')
    {
        $returnType = '\Swagger\Client\Model\GetLocationsResponse';
        $request = $this->getLocationsRequest($body, $instance_id, $connection_id, $test_mode);
     ...
     */
    protected function getLocationsRequest($body, $instance_id, $connection_id, $test_mode = 'false')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling getLocations'
            );
        }
