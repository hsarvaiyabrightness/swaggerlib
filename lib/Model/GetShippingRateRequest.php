...
class GetShippingRateRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'customs_duty' => 'string',
        'alternative_send_to' => '\Swagger\Client\Model\AlternativeSendTo'
    ];
    ...
    protected static $attributeMap = [
        ...
        'alternative_send_to' => 'alternativeSendTo'
    ];
    ...
    protected static $setters = [
        ...
        'alternative_send_to' => 'setAlternativeSendTo'
    ];
    ...
    protected static $getters = [
        ...
        'alternative_send_to' => 'getAlternativeSendTo'
    ];
    ...
    const CUSTOMS_DUTY_DDP = 'DDP';
    const CUSTOMS_DUTY_DDU = 'DDU';
     ...
     * @return string[]
     */
    public function getCustomsDutyAllowableValues()
    {
        return [
            self::CUSTOMS_DUTY_DDP,
            self::CUSTOMS_DUTY_DDU,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['alternative_send_to'] = isset($data['alternative_send_to']) ? $data['alternative_send_to'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getCustomsDutyAllowableValues();
        if (!is_null($this->container['customs_duty']) && !in_array($this->container['customs_duty'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'customs_duty', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
    ...
    {
        $allowedValues = $this->getCustomsDutyAllowableValues();
        if (!is_null($customs_duty) && !in_array($customs_duty, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'customs_duty', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    /**
     * Gets alternative_send_to
     *
     * @return \Swagger\Client\Model\AlternativeSendTo
     */
    public function getAlternativeSendTo()
    {
        return $this->container['alternative_send_to'];
    }

    /**
     * Sets alternative_send_to
     *
     * @param \Swagger\Client\Model\AlternativeSendTo $alternative_send_to alternative_send_to
     *
     * @return $this
     */
    public function setAlternativeSendTo($alternative_send_to)
    {
        $this->container['alternative_send_to'] = $alternative_send_to;
