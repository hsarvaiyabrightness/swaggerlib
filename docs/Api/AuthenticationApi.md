...
[**patch**](AuthenticationApi.md#patch) | **PATCH** /instances/{instanceId}/connections/{connectionId}/shipping/auth/v2 | Update the connection
...
# **patch**
> object patch($body, $instance_id, $connection_id, $test_mode)
